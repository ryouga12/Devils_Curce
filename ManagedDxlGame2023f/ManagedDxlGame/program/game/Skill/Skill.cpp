...
//カオスフレア
ChaosFlare::ChaosFlare():Skill(5 , "カオスフレア", 2.5f , "一点集中の火の玉を放ち、命中した敵に大ダメージを与える",0 , AttackType)
{
	//アニメーションを作成する
...
//デスウィンド
DeathScytheWind::DeathScytheWind() :Skill(6, "デスウィンド", 2.5f, "強力な風属性の魔法を放つ", 0, AttackType)
{
	//アニメーションを作成する
